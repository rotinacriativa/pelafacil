  ...
  return (
    <Layout>
      ...
      <main className="flex-1 w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeGroups.length === 0 && searchTerm === '' && (
          <div className="flex flex-col items-center justify-center py-20 px-4">
            <div className="max-w-md w-full bg-surface-light dark:bg-surface-dark rounded-2xl p-8 text-center shadow-lg border border-gray-100 dark:border-gray-800">
              <h2 className="text-2xl font-black text-text-main dark:text-white mb-4">
                Bem-vindo ao PelaFacil ⚽
              </h2>
              <p className="text-text-muted dark:text-gray-400 mb-6 text-base">
                Para começar, você precisa criar um grupo de pelada ou entrar em um grupo existente.
              </p>

              <div className="flex flex-col gap-3">
                <button
                  onClick={() => navigate('/create-group')}
                  className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-primary-dark text-text-main px-6 py-4 rounded-xl font-bold shadow-lg shadow-primary/20 transition-all active:scale-95"
                >
              ...
              <p className="text-xs text-text-muted dark:text-gray-500 mt-4">
